...
func Get_project_username_project_envvarHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/project/%s/%s/envvar%s", cfg.BaseURL, username, project, queryString)
...
func CreateGet_project_username_project_envvarTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_project_username_project_envvar",
		mcp.WithDescription("Lists the environment variables for :project
"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_project_username_project_envvarHandler(cfg),
	}
}
