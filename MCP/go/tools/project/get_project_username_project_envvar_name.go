...
func Get_project_username_project_envvar_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_project_username_project_envvar_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_project_username_project_envvar_name",
		mcp.WithDescription("Gets the hidden value of environment variable :name
"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_project_username_project_envvar_nameHandler(cfg),
	}
}
