...
func Post_project_username_project_envvarHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_project_username_project_envvarTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_project_username_project_envvar",
		mcp.WithDescription("Creates a new environment variable
"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_project_username_project_envvarHandler(cfg),
	}
}
