...
func Post_project_username_project_checkout_keyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/project/%s/%s/checkout-key%s", cfg.BaseURL, username, project, queryString)
...
func CreatePost_project_username_project_checkout_keyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_project_username_project_checkout-key",
		mcp.WithDescription("Creates a new checkout key.
...
"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_project_username_project_checkout_keyHandler(cfg),
	}
}
