/**
 * MCP Server function for Gets the hidden value of environment variable :name
 */
...
class Get_Project_Username_Project_Envvar_NameMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Project_Username_Project_Envvar_NameHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("name")) {
            queryParams.add("name=" + args.get("name"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_project_username_project_envvar_name" + queryString;
    ...
    public static MCPServer.Tool createGet_Project_Username_Project_Envvar_NameTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_project_username_project_envvar_name",
            "Gets the hidden value of environment variable :name",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Project_Username_Project_Envvar_NameHandler(config));
    }
