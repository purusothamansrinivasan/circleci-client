/**
 * MCP Server function for Cancels the build, returns a summary of the build.
 */
...
class Post_Project_Username_Project_Build_Num_CancelMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Project_Username_Project_Build_Num_CancelHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("build_num")) {
            queryParams.add("build_num=" + args.get("build_num"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_project_username_project_build_num_cancel" + queryString;
    ...
    public static MCPServer.Tool createPost_Project_Username_Project_Build_Num_CancelTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_project_username_project_build_num_cancel",
            "Cancels the build, returns a summary of the build.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Project_Username_Project_Build_Num_CancelHandler(config));
    }
