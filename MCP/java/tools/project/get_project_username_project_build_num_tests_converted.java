/**
 * MCP Server function for Provides test metadata for a build
...
class Get_Project_Username_Project_Build_Num_TestsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Project_Username_Project_Build_Num_TestsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("build_num")) {
            queryParams.add("build_num=" + args.get("build_num"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_project_username_project_build_num_tests" + queryString;
    ...
    public static MCPServer.Tool createGet_Project_Username_Project_Build_Num_TestsTool(MCPServer.APIConfig config) {
...
Note: [Learn how to set up your builds to collect test metadata](https://circleci.com/docs/test-metadata/)",
        ...
        return new MCPServer.Tool(definition, getGet_Project_Username_Project_Build_Num_TestsHandler(config));
    }
